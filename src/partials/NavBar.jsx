            ...
            <nav className="bg-gray-50 shadow-md py-4">
                ...
                <div className="flex items-center space-x-6">
                  ...
                  <div className="flex items-center space-x-2">
                    <img
                      ...
                      className="h-10 w-10"
                    />
                    <span className="font-bold md:text-xl text-indigo-800">FTI Nexus</span>
                  </div>
              ...
              {isOpen && (
                <div className="md:hidden px-6 pt-4 pb-2 ">
                  <a href="#" className="block text-gray-700 py-2 hover:text-indigo-600">
                    Top Market
                  </a>
                  <a href="#" className="block text-gray-700 py-2 hover:text-indigo-600">
                    Founded
                  ...
                  <a
                    href="/login"
                    className="block text-center text-indigo-700 py-2 hover:text-indigo-600"
                  >
                    Log In
                  </a>
                  <a
                    href="/create-account"
                    className="block  text-center bg-indigo-700 text-white px-4 py-2 mt-2 rounded-lg hover:bg-indigo-800"
                  >
                    Register
                  </a>
                </div>
